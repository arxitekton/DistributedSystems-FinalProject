            ...
            <div class="panel-body">
                ...
                <form:form action="${pageContext.request.contextPath}/user/register" commandName="user" method="POST" enctype="utf8" role="form">
                    ...
                    -->
						...
						<div class="row">
							<div id="form-group-usePhoneCall" class="form-group col-lg-4">
								<label class="control-label" for="user-usePhoneCall"><spring:message code="label.user.usePhoneCall"/>:</label>
								<input id="user-usePhoneCall" name="usePhoneCall" type="checkbox" class="form-control"/>
							</div>
						</div>
  
						<div class="row">
							<div id="form-group-useSMS" class="form-group col-lg-4">
								<label class="control-label" for="user-useSMS"><spring:message code="label.user.useSMS"/>:</label>
								<input id="user-useSMS" name="useSMS" type="checkbox" class="form-control"/>
							</div>
						</div>
